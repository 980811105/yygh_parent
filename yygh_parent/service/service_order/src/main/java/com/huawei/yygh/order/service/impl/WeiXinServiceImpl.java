...
import com.huawei.yygh.order.utils.ConstantPropertiesUtils;
import com.huawei.yygh.order.utils.HttpClient;
...
public class WeiXinServiceImpl implements WeiXinService {
    ...
    public Map createNative(Long orderId) {
        try {
            ...
            //2、向支付记录表添加信息
            paymentService.savePaymenyInfo(orderInfo, PaymentTypeEnum.WEIXIN.getStatus());
            //3、设置参数,调用微信生成二维码接口
            //把参数准换xml格式，使用商户key进行加密
