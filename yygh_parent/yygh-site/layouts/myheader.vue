<template>
    <div class="header-container">
        ...
        <!-- 登录弹出层 -->
    <el-dialog :visible.sync="dialogUserFormVisible" style="text-align: left;" top="50px" :append-to-body="true" v-if=dialogUserFormVisible width="960px" @close="closeDialog()">
      <div class="container">
        <!-- 手机登录 #start -->
